...
%% Generate samples of fixed parameters (wear)
...
%% Repeat the entire analysis 100 times ~ manufacturing 100 parts
...
for k=1:nrepeat
    ...
    for i=2:ntimesteps % There are ntimesteps+1, we will do the last one separately
        ...
        %run('PlotCalibration_alpha.m')
        %run('PlotCalibration_beta.m')
%         
