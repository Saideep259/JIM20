...
%% This code to compute first order sensitivity indices is borrowed from the following paper

% Title: "An efficient modularized sample-based method to estimate the first-order
% Sobol’index"

% Authors: Li, C, and Mahadevan, S
